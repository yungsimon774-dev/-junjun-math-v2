...
function header(){$("#title").textContent=cfg.appName||"峻峻数学大冒险";$("#ver").textContent=cfg.version||"V6.4 普通话专用版";$("#stars").textContent=st.stars;$("#done").textContent=st.done.length;$("#acc").textContent=st.attempts?Math.round(st.correct/st.attempts*100)+"%":"—"}
