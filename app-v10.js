...
function showThinking(){openModal("🧠","思维拓展",`<div class="feature-copy"><h3>V10 图形代数与思维训练</h3><p>新增苹果雪梨等量代换、符号推理、连续代换和未知数启蒙。</p><button id="startThinking" class="claim-button">开始图形代数挑战</button></div>`);setTimeout(()=>{const b=document.querySelector("#startThinking");if(b)b.onclick=()=>{closeModal();const c=courses.find(x=>x.set==="g2_symbol");if(c)start(c.id)}},0)}
function showTools(){openModal("🧮","数学工具",`<div class="achievement-list"><div class="achievement-card unlocked"><div class="achievement-icon">🔢</div><div><b>数位表</b><p>个位、十位、百位的组成练习。</p></div></div><div class="achievement-card unlocked"><div class="achievement-icon">📏</div><div><b>单位小助手</b><p>米、厘米、元、角、分和时间换算提示。</p></div></div><div class="achievement-card unlocked"><div class="achievement-icon">🧾</div><div><b>版本信息</b><p>V10.0，外接大题库；新增360道图形代数与等量代换题，已批量修正量词。</p></div></div></div>`)}
